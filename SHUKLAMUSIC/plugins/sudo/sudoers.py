...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_video(video="https://telegra.ph/file/c9e885b6511eaeeb0d0dd.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("𝐍𝐢𝐤𝐚𝐥 𝐁𝐬𝐝𝐤 𝐌𝐜 𝐁𝐚𝐝𝐚 𝐀𝐲𝐚 𝐒𝐮𝐝𝐨𝐥𝐢𝐬𝐭 𝐃𝐞𝐤𝐡𝐧𝐞 𝐕𝐚𝐥𝐚 𝐇𝐭𝐭 𝐁𝐜🖕😎😂", show_alert=True)
    else:
        ...
        keyboard.append([InlineKeyboardButton("👉🏻 𝐕ɪᴇᴡ 𝐎ᴡɴᴇʀ 👈🏻", url=f"tg://openmessage?user_id={OWNER_ID}")])
        ...
        keyboard.append([InlineKeyboardButton("⚡ 𝐁𝐀𝐂𝐊 ⚡", callback_data="back_to_main_menu")])
